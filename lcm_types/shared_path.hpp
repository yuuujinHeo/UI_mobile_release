...
int shared_path::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int shared_path::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int shared_path::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t shared_path::getHash()
{
    static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
    return hash;
}

const char* shared_path::getTypeName()
{
    return "shared_path";
}

int shared_path::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int shared_path::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int shared_path::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t shared_path::_computeHash(const __lcm_hash_ptr *)
{
    uint64_t hash = 0xb45cc2a0d52e8664LL;
